...
public class App {
	...
	public static void main(String[] args) {
		...
		INotificationObserver admin1 = new Admin(service, "Mr. X", 100);
		// less than or equal to 100 so it doesnt print
		INotificationObserver admin3 = new Admin(service, "Mr. Y", 102);
		INotificationObserver admin2 = new Admin(service, "Mr. Z", 101);
